...
public class OrderCreateServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // out.println("<input type='number' name='customer_id' placeholder='ID Клиента'>");
        // out.println("<input type='number' name='product_id' placeholder='ID Продукта'>");
        // out.println("<input type='number' name='quantity' placeholder='Количество'>");
